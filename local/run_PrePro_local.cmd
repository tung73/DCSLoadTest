...
REM Local smoke run for DFCS PrePro
set "SCRIPT_DIR=%~dp0"
...
set "OUTDIR=%SCRIPT_DIR%\output_PrePro_%_d%%_t%"
...
REM Count data lines (exclude header). Empty jtl causes JsonExporter NPE with -e -o.
set "LINES=0"
